...
def docking_with_qvina02(work_dir, protein_pdbqt, lig_pdbqt, centroid, verbose=1, out_lig_sdf=None, save_pdbqt=False):
    '''
...
def scoring_with_qvina02(work_dir, protein_pdbqt, lig_pdbqt, centroid, out_lig_sdf=None):
    '''
    work_dir: is same as the prepare_target
    protein_pdbqt: .pdbqt file
    lig_sdf: ligand .sdf format file
